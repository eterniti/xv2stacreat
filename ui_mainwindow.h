...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(20, 20, 621, 400));
        ...
        gate8Button->setGeometry(QRect(470, 280, 75, 23));
        gate9Button = new QPushButton(defTab);
        gate9Button->setObjectName(QStringLiteral("gate9Button"));
        gate9Button->setGeometry(QRect(250, 340, 75, 23));
